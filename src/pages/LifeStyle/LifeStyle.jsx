    ...
    <>
      ...
      <div className='container-xxl  zero-padding mt-ls' >
        ...
        <div className="col-md-6">
          ...
          <SwiperSlide>
          <img src={PostSliderOne} align="right" class="img-fluid img-post-1" alt="Imagem responsiva" />
          </SwiperSlide>
          <SwiperSlide>
          <img src={PostSliderOne2} align="right" class="img-fluid img-post-1" alt="Imagem responsiva" />
          </SwiperSlide>
            </Swiper>
            </div>
      ...
      <div className='container-xxl zero-padding mt-post-2' id="mt-post-2">
        <div className="row">
          ...
          <Swiper navigation={true} modules={[Navigation]} className="mySwiper-2">
           <SwiperSlide>
            <img src={PostSliderTwo} align="left" class="img-fluid img-fluid-tm" alt="Imagem responsiva" />
            </SwiperSlide>
            <SwiperSlide>
            <img src={PostSliderTwo2} align="left" class="img-fluid img-fluid-tm-2" id="img-fluid-tm-2" alt="Imagem responsiva" />
          </SwiperSlide>
          </Swiper>
           </div>
           <div className="col-md-6 ">
            <div className="mt-ls-1 resp-style">
              <p class="font-1-style respon-txt text-center" data-aos="fade-left" data-aos-duration="1000" >Bold Atelier Collection</p>
              </div>
              <div className="">
              <p class="font-2-style mt-1 text-center " data-aos="fade-left" data-aos-duration="1000" >Exclusive design style</p>
              </div>
            <img src={LogoBold} align="left" class="img-fluid img-bold mt-5" id="img-bold" alt="Imagem responsiva"  data-aos-duration="1500" data-aos="fade-left"/>
            </div>
        </div>
      </div>
      {/* POST 3 */}
      <div className='container-xxl zero-padding mt-respon ' id="mt-respon">
        ...
        <div className="col-md-6">
              ...
              <p class="font-mindset text-center" data-aos="fade-right" data-aos-duration="1000" >Mindset is everything!</p>
              </div>
              <div className="respon-post3" id="">
              <p class="font-mind-2  text-center" id="font-mind-2" data-aos="fade-right" data-aos-duration="1500">The weapon against bad luck is the positive energy generated by good thoughts.</p>
              </div>
          </div>
          ...
          <SwiperSlide align="left">
            <img src={PostSliderThree} align="left" class="img-fluid img-fluid-light" alt="Imagem responsiva" />
            </SwiperSlide>
            <SwiperSlide align="left">
            <img src={PostSliderThree2} align="left" class="img-fluid img-fluid-light" alt="Imagem responsiva" />
            </SwiperSlide>
            </Swiper>
            </div>
        </div>
        ...
        <section className='container-xxl zero-padding'>
          <div className="row "> 
            <div className="col-md-6 zero-padding respon-post4">
              ...
              <SwiperSlide>
              <img src={PostSliderFour} align="left" class="img-fluid " alt="Imagem responsiva" />

              </SwiperSlide>
              <SwiperSlide> 
              <img src={PostSliderFour2} align="left" class="img-fluid " alt="Imagem responsiva" />
              </SwiperSlide>
              </Swiper>
              </div>
              ...
              <div className="col-md-6  mt-stst " id="mt-stst">
                  <div className=" resp-style4">
                      <p class="font-favorite  text-center" data-aos="fade-right" data-aos-duration="1000">Favorite outfit </p>
                  </div>
                  <div>
                  <p class="font-2-style mt-1 text-center" data-aos="fade-right" data-aos-duration="1000">this season</p>
                  <p class="font-1-style mt-1 text-center" data-aos="fade-right" data-aos-duration="1000" >Good Shoes </p>
                  <p class="font-1-style mt-1 text-center" data-aos="fade-right" data-aos-duration="1000">Take you </p>
                  <p class="font-1-style mt-1 text-center" data-aos="fade-right" data-aos-duration="1000">Good Place </p>
                  </div>
               </div>
           </div>
        </section>
      ...
      <div className='container mt-5 mb-5'>
        <div className="row ">
          <div className="col ">
            <img src={CapaFinal} class="img-fluid img-capafinal rounded mx-auto d-block" alt="Imagem responsiva" />
          </div>
        </div>
      </div>
      ...
      <section id='marg-mb-lifestyle'>
        <div className="col d-flex justify-content-center">
                ...
                <>
                  <button class="accordioon-lifestyle">
