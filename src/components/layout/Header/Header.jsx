    ...
    <div className="text-1 container" id='text'>
      <div className="row">
        <div className=" divLeft  ">
            <div className="textDiv mt-4">
              <div className="justify-content-md-center " >
                <h1 className="ml-2 h1-name md-ia"><i id="spaceText" ></i > EXPERIENCE THE BUGATTI CHIRON</h1>
                  <div className="col-7 offset-md-0 ">
                    <h3 className='mb-5  h5-md md-ib'>Bugatti 
                    Chiron, muito além do limite </h3>
                <a href="#!" className=" offset-md-2 botao-dev">SAIBA MAIS</a>
              </div>
            </div>
          </div>
        </div>
